...
class AddBookView(MethodView):
    def get(self):
        return render_template("add__book.html", year=datetime.now().year)
    ...
    def post(self):
        ...
        if book:
            ...
            return redirect(url_for("main.add__book"))
        book = Book(
            name=name,
            author=author,
...
main.add_url_rule(
    "/add/book",
    view_func=login_required(AddBookView.as_view("add__book")),
)
main.add_url_rule(
